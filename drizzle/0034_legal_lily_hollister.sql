...
ALTER TABLE "deliverables" ADD CONSTRAINT "deliverables_projectId_projects_id_fk" FOREIGN KEY ("projectId") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;